...
class DatabaseManager:
    ...
    def _save_scores(self, results):
        ...
        INSERT INTO {self.schema_name}.dq_scores (
            quarter_id, run_timestamp, total_records, overall_score, status,
            completeness_score, completeness_points,
            consistency_score, consistency_points,
            reasonableness_score, reasonableness_points,
            data_quality_score, data_quality_points,
            temporal_logic_score, temporal_logic_points,
            total_checks, passed_checks, warning_checks, failed_checks, critical_issues_count
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """

        self.cursor.execute(query, (
            quarter_id, timestamp, total_records, overall_score, status,
            category_scores['completeness']['percentage'], category_scores['completeness']['points_earned'],
            category_scores['consistency']['percentage'], category_scores['consistency']['points_earned'],
            category_scores['reasonableness']['percentage'], category_scores['reasonableness']['points_earned'],
            category_scores['data_quality']['percentage'], category_scores['data_quality']['points_earned'],
            category_scores['temporal_logic']['percentage'], category_scores['temporal_logic']['points_earned'],
            summary['total_checks'], summary['passed'], summary['warnings'], summary['failed'], summary['critical_issues_count']
        ))
